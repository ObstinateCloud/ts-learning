...
// 全局申明
let myNameEveryArea = 'Tom';
// 局部申明
let myNameArea = 'Tom';
let myAge = 25;
let myIsAlive = true;
let myFriends = ['Tom', 'Jerry'];
...
// 断言 as
myNameArea5 = myNameArea3; // 方式2 断言处理后可以进行赋值
myNameArea5 = myNameArea3; // 方式2 断言处理后可以进行赋值 断言的另一种写法
// any和unknown的区别
let myNameArea6 = 'Tom';
myNameArea6 = 25;
...
myNameArea7.toLocaleLowerCase; // 断言处理后可以进行操作
// never类型 表示不能返回任何值的函数 如果不写默认 会返回undefined
function errorDeal(message) {
